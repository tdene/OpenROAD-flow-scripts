...
export SC_LEF = $(PLATFORM_DIR)/lef/sky130_osu_sc_18T_ms.lef

export LIB_FILES = $(PLATFORM_DIR)/lib/sky130_osu_sc_18T_ms_TT_1P8_25C.ccs.lib \
                     $(ADDITIONAL_LIBS)
...
#
# Define fill cells
export FILL_CELLS = sky130_osu_sc_18T_ms__fill_1 \
	sky130_osu_sc_18T_ms__fill_2 \
	sky130_osu_sc_18T_ms__fill_4 \
	sky130_osu_sc_18T_ms__fill_8 \
	sky130_osu_sc_18T_ms__fill_16 \
	sky130_osu_sc_18T_ms__fill_32
...
export TIEHI_CELL_AND_PORT = sky130_osu_sc_18T_ms__tiehi Y
export TIELO_CELL_AND_PORT = sky130_osu_sc_18T_ms__tielo Y

# Used in synthesis
export MIN_BUF_CELL_AND_PORTS = sky130_osu_sc_18T_ms__buf_2 A Y
...
export ABC_DRIVER_CELL = sky130_osu_sc_18T_ms__buf_1
...
#  -------------------------------------------------------
# TritonCTS options
export CTS_BUF_CELL   = sky130_osu_sc_18T_ms__buf_1
