...
# Tech/Libs
# ----------------------------------------------------
export TECH_LEF = $(PLATFORM_DIR)/lef/sky130_osu_sc_15T.tlef
export SC_LEF = $(PLATFORM_DIR)/lef/sky130_osu_sc_15T_ls.lef

export LIB_FILES = $(PLATFORM_DIR)/lib/sky130_osu_sc_15T_ls_TT_1P8_25C.ccs.lib \
                     $(ADDITIONAL_LIBS)
...
#
# Define fill cells
export FILL_CELLS = sky130_osu_sc_15T_ls__fill_1 \
	sky130_osu_sc_15T_ls__fill_2 \
	sky130_osu_sc_15T_ls__fill_4 \
	sky130_osu_sc_15T_ls__fill_8 \
	sky130_osu_sc_15T_ls__fill_16 \
	sky130_osu_sc_15T_ls__fill_32
...
export TIEHI_CELL_AND_PORT = sky130_osu_sc_15T_ls__tiehi Y
export TIELO_CELL_AND_PORT = sky130_osu_sc_15T_ls__tielo Y

# Used in synthesis
export MIN_BUF_CELL_AND_PORTS = sky130_osu_sc_15T_ls__buf_2 A Y
...
export ABC_DRIVER_CELL = sky130_osu_sc_15T_ls__buf_1
...
#  -------------------------------------------------------
# TritonCTS options
export CTS_BUF_CELL   = sky130_osu_sc_15T_ls__buf_1
